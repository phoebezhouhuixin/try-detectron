...
run_win_cmd("python voc2coco.py --ann_dir=data/train --labels=data/labels.txt --output=data/train_annots.json")
run_win_cmd("python voc2coco.py --ann_dir=data/validate --labels=data/labels.txt --output=data/validate_annots.json")
run_win_cmd("python voc2coco.py --ann_dir=data/test --labels=data/labels.txt --output=data/test_annots.json")
...
# cfg.MODEL.DEVICE = "cpu" # TODO: without this, mac gets an error when importing torch
